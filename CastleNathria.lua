...
function CastleNathria:OnEnable()
	local name = "Castle Nathria"
	self:RegisterExpansion('Shadowlands', EXPANSION_NAME8)
	self:RegisterRaidTier('Shadowlands', 91190, name, PLAYER_DIFFICULTY1, PLAYER_DIFFICULTY2, PLAYER_DIFFICULTY6)
	self:RegisterRaidInstance(91190, castleNathria, name, {
		bonusids = {
			[1] = {7189, 1472},
			[2] = {7188, 1485},
			[3] = {7187, 1498},
...
function CastleNathria:InitializeZoneDetect(ZoneDetect)
	ZoneDetect:RegisterMapID(2296, castleNathria)
	...
	ZoneDetect:RegisterNPCID(166971, castleNathria, 7) --The Council of Blood
	ZoneDetect:RegisterNPCID(166969, castleNathria, 7) --The Council of Blood
	ZoneDetect:RegisterNPCID(166970, castleNathria, 7) --The Council of Blood
	ZoneDetect:RegisterNPCID(174733, castleNathria, 8) --Sludgefist
	ZoneDetect:RegisterNPCID(165318, castleNathria, 9) --Stone Legion Generals
	ZoneDetect:RegisterNPCID(170323, castleNathria, 9) --Stone Legion Generals
